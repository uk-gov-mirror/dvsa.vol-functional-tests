...
public class RemoveTM extends BasePage implements En {
    ...
    public RemoveTM() throws Exception {
        ...
        When("^the last transport manager has been removed by an internal user$", () -> {
            ...
            selectValueFromDropDown("//select[@id='search-select']", SelectorType.XPATH, "LicenceBuilder");
            do {
                SearchNavBar.search(goodsApp.getLicenceNumber());
            } while (!isLinkPresent(goodsApp.getLicenceNumber(), 60));
