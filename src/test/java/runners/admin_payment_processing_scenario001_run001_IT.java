...
@CucumberOptions(plugin = {"io.qameta.allure.cucumber2jvm.AllureCucumber2Jvm"},
        features = {"src/test/resources/parallel/features/admin_payment_processing_scenario001_run001_IT.feature"},
        glue = {"org.dvsa.testing.framework.stepdefs"}
)
public class admin_payment_processing_scenario001_run001_IT {
}
