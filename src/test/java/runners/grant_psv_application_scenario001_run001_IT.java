...
@CucumberOptions(plugin = {"io.qameta.allure.cucumber2jvm.AllureCucumber2Jvm"},
        features = {"src/test/resources/parallel/features/grant_psv_application_scenario001_run001_IT.feature"},
        glue = {"org.dvsa.testing.framework.stepdefs"}
)
public class grant_psv_application_scenario001_run001_IT {
}
