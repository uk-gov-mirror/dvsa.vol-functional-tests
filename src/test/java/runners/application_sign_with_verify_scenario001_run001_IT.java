...
@CucumberOptions(plugin = {"io.qameta.allure.cucumber2jvm.AllureCucumber2Jvm"},
        features = {"src/test/resources/parallel/features/application_sign_with_verify_scenario001_run001_IT.feature"},
        glue = {"org.dvsa.testing.framework.stepdefs"}
)
public class application_sign_with_verify_scenario001_run001_IT {
}
