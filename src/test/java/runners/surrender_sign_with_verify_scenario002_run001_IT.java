...
@CucumberOptions(plugin = {"io.qameta.allure.cucumber2jvm.AllureCucumber2Jvm"},
        features = {"src/test/resources/parallel/features/surrender_sign_with_verify_scenario002_run001_IT.feature"},
        glue = {"org.dvsa.testing.framework.stepdefs"}
)
public class surrender_sign_with_verify_scenario002_run001_IT {
}
