...
@CucumberOptions(plugin = {"io.qameta.allure.cucumber2jvm.AllureCucumber2Jvm"},
        features = {"src/test/resources/parallel/features/tm_verify_on_different_operator_scenario004_run001_IT.feature"},
        glue = {"org.dvsa.testing.framework.stepdefs"}
)
public class tm_verify_on_different_operator_scenario004_run001_IT {
}
