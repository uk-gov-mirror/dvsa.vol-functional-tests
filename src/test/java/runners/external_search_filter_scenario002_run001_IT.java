...
@CucumberOptions(plugin = {"io.qameta.allure.cucumber2jvm.AllureCucumber2Jvm"},
        features = {"src/test/resources/parallel/features/external_search_filter_scenario002_run001_IT.feature"},
        glue = {"org.dvsa.testing.framework.stepdefs"}
)
public class external_search_filter_scenario002_run001_IT {
}
